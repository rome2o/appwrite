...
# Executables
RUN chmod a+w /usr/local/bin/doctor && \
    chmod a+w /usr/local/bin/maintenance && \
    chmod a+w /usr/local/bin/usage && \
    chmod a+w /usr/local/bin/install && \
    chmod a+w /usr/local/bin/migrate && \
    chmod a+w /usr/local/bin/realtime && \
    chmod a+w /usr/local/bin/executor && \
    chmod a+w /usr/local/bin/schedule && \
    chmod a+w /usr/local/bin/sdks && \
    chmod a+w /usr/local/bin/specs && \
    chmod a+w /usr/local/bin/ssl && \
    chmod a+w /usr/local/bin/test && \
    chmod a+w /usr/local/bin/vars && \
    chmod a+w /usr/local/bin/worker-audits && \
    chmod a+w /usr/local/bin/worker-certificates && \
    chmod a+w /usr/local/bin/worker-database && \
    chmod a+w /usr/local/bin/worker-deletes && \
    chmod a+w /usr/local/bin/worker-functions && \
    chmod a+w /usr/local/bin/worker-builds && \
    chmod a+w /usr/local/bin/worker-mails && \
    chmod a+w /usr/local/bin/worker-webhooks
